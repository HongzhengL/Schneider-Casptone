...
function getRetryAfter(status) {
  switch (status) {
    case 429: return 60; // 1 minute for rate limiting
    case 502: return 30; // 30 seconds for bad gateway
    case 503: return 60; // 1 minute for service unavailable
    case 504: return 30; // 30 seconds for gateway timeout
    default: return null;
  }
}
