    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Waiting to accept a load reduces your earnings. Here’s how much
            downtime costs based on your fixed expenses.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-2 text-sm">
          {[1, 2].map((day) => (
            <p key={day}>
              Wait {day} day{day > 1 ? "s" : ""}: −${day * fixedCostPerDay} from
              this week
            </p>
          ))}
        </div>
