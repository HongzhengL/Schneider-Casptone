...
interface DropDatePageProps {
    onNavigate: (page: string) => void;
    onDateConfirm?: (fromDate: Date, toDate: Date) => void;
}

export function DropDatePage({ onNavigate, onDateConfirm }: DropDatePageProps) {
    ...
    const [selectedRange, setSelectedRange] = useState<{
        ...
        to: new Date(2025, 7, 22), // Aug 22, 2025
    });
        ...
        <div className="p-4 space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <button onClick={() => onNavigate('search')} className="text-gray-600">
                        <ChevronLeft className="w-6 h-6" />
                    </button>
                    <h1 className="text-orange-500">Drop Date</h1>
                </div>
                <button
            ...
            {/* Drop Date Info */}
            <div className="space-y-4">
                <h3 className="text-gray-900">Drop Date</h3>
