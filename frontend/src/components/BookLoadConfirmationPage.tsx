                ...
                <div className="bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200 rounded-lg p-4 shadow-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-medium text-gray-900">${loadedRpm.toFixed(2)}/mi</span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-medium text-gray-900">${margin.toFixed(2)}/mi</span>
                        </div>
                        <div className="border-t border-orange-200 pt-2 mt-2">
                            <div className="flex justify-between items-center">
                                <span className="text-sm font-medium text-gray-700">Net Profit/Mile</span>
                                <span
                ...
                {!isProfitable && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-medium text-red-800">Below Profitability Threshold</p>
                                <p className="text-xs text-red-700 mt-1">
                                    This load doesn't meet your target margin. Consider negotiating a higher rate or finding a better opportunity.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                >
                                    {load.confirmedAppointment ? '✓ Confirmed Appointment' : 'Standard Network'}
                                </span>
                            </div>
                        </div>
                    </div>
