        ...
        <div className="bg-background text-foreground min-h-screen">
            ...
            <div className="p-4 border-b bg-accent">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h1 className="text-xl text-primary">My Completed Runs</h1>
                </div>
                    ...
                    visibleTrips.map((trip) => (
                        ...
                        >
                            ...
                            <div className="space-y-2 mb-3">
                                ...
                                <div className="ml-1.5 border-l-2 border-border h-4"></div>
                                <div className="flex items-start gap-2">
                                    <div className="w-3 h-3 rounded-full bg-green-500 mt-1 flex-shrink-0"></div>
                                    <div>
                                        <p className="text-sm text-foreground">{trip.toLocation}</p>
                                        <p className="text-xs text-muted-foreground">
                                            Delivered:{' '}
                            ...
                            <div className="flex gap-4 py-3 border-t border-border">
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-foreground">{trip.distance}</p>
                                </div>
                                <div className="flex-1">
                                    <p className="text-xs text-muted-foreground">Weight</p>
                                    <p className="text-sm text-foreground">{trip.weight}</p>
                                </div>
                                <div className="flex-1">
                                    <p className="text-xs text-muted-foreground">Loaded RPM</p>
                                    <p className="text-sm text-foreground">{trip.loadedRpm}</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-3 pt-3 border-t border-border">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-orange-600 bg-accent px-2 py-1 rounded">
                                        {trip.loadType}
                                    </span>
                                    <p className="text-xs text-muted-foreground">
                                        {trip.details.split('\\n')[0]}
